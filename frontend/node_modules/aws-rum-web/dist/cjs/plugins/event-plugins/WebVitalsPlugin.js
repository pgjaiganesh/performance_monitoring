...
var WebVitalsPlugin = /** @class */ (function (_super) {
    ...
    WebVitalsPlugin.prototype.onload = function () {
        var _this = this;
        (0, web_vitals_1.onLCP)(function (data) { return _this.getWebVitalData(data, constant_1.LCP_EVENT_TYPE); });
        (0, web_vitals_1.onFID)(function (data) { return _this.getWebVitalData(data, constant_1.FID_EVENT_TYPE); });
        (0, web_vitals_1.onCLS)(function (data) { return _this.getWebVitalData(data, constant_1.CLS_EVENT_TYPE); });
    };
